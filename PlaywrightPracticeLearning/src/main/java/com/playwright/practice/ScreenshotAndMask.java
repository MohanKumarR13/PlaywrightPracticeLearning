...
//		byte[] screenshot = page.screenshot();
		...
		searchLocator.screenshot(
				new Locator.ScreenshotOptions().setPath(Paths.get("./snaps/hide.png")).setCaret(ScreenshotCaret.HIDE));
...
//				.setMask(Arrays.asList(searchLocator)));
		page.screenshot(new ScreenshotOptions().setPath(Paths.get("./snaps/initial.png"))
				.setCaret(ScreenshotCaret.INITIAL).setMask(Arrays.asList(searchLocator)));
